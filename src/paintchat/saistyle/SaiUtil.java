...
public class SaiUtil {
	private static final SaiUtil classLoaderInstance = new SaiUtil();
	private static XMLElement settingsRoot = null;
     ...
     */
	public static BufferedImage getSmallerScaledInstance(BufferedImage img,
            int targetWidth,
            int targetHeight) {
