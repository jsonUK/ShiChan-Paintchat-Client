...
public class TPicNormal extends LComponent
{

    public TPicNormal(Tools tools1)
    {
        iDrag = -1;
        sizePalette = 20;
        selPalette = 0;
        oldColor = 0;
        isRGB = 1;
        System.out.println(66F * LComponent.Q);
        System.out.println(128F * LComponent.Q);
        System.out.println(284F * LComponent.Q);
    ...
    {
        int ai[] = tools.iBuffer;
        int h = (int)(64F * LComponent.Q);
        int w = (int)(22F * LComponent.Q);
        int ai1[] = ai;
        int k = 0;
        float f = 0.0F;
